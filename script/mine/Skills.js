...
skills.push(new Skill("img/php.svg","php","PHP",3,"POO, POE, MVC, emails, manipulação de cookies e sessões, conexão ao banco de dados(PDO), manipução de recepção de arquivos, consumo e criação de webservices JSON"));
skills.push(new Skill("img/node.svg","node","Node.JS",3,"POO, POE, padrão MVC, conexão ao banco de dados(MySql), manipução de recepção de arquivos, consumo de webservices, Criação de API's,(Express, Nodemon, Ejs, body-parser), NPM"));
...
skills.push(new Skill("img/mysql.svg","mysql","MySql Programmer",4,"Selects(Simples, joins, subselects), uso de Workbench, criação do banco de dados(relação PK, FK, UQ, objeto de resolução), passagem de toda regras de negócio para o banco, criação de views, procedures, functions, cursores, regex, MD5"));
skills.push(new Skill("img/sqlite.png","sqlite3","Sqlite 3",3,"Selects(Simples, joins, subselects), criação do banco de dados(relação PK, FK, UQ, objeto de resolução), passagem de toda regras de negócio para o banco"));
...
skills.push(new Skill("img/css-3.svg","css","Css 3",3,"Seletores(tag, class, id); Animação(Transição), Filtros, eventos(hover, active, visited, etc), Framework(Bootstrap 4.1), manipulação de filhos, gradientes, @media"));
skills.push(new Skill("img/js.png","js","Javascript",3,"POO, POE, manipulação de eventos, DOM, Animação, manipução de cookies, Framework/biblioteca(Bootstrap 4.1, Jquery, SweetAlert), consumo de webservices, básico de ecmascript, Callbacks"));
skills.push(new Skill("img/csharp.svg","csharp","C#",4,"POO, POE, MVC, emails, conexão ao banco de dados(MySql, SqlServer), NUGET, consumo de webservice e apis, geração de relátorios, manipulação e criação de arquivos, consumo de dados via bluetooth"));
skills.push(new Skill("img/java.svg","java","Java",3,"POO, POE, MVC, emails, conexão ao banco de dados(MySql), geração de relátorios"));
skills.push(new Skill("img/python.png","py","Python",3,"POO, Ponteiros, manipulação de strings, básico de Django(formato MTV), uso de banco de dados mysql, uso de bibliotecas, envio de emails"));
...
skills.push(new Skill("img/unity.png","unity","Unity",4,"Uso da linguagem C#(POO, POE), desenvolvimento 2D e 3D, manipução de assets, criação de animação, scriptable objects, bibliotecas(PlayerPrefsX, Dragable), Prefabs, Sistema RPG(exp, combate, história), conexão ao banco de dados(MySql), consumo de webservices, consumo de dados via bluetooth"));
